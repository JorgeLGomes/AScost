...
def main():
    ...
    var, ds_grid, depth_vector, ds_var, uv, lati, latf, loni, lonf, fnts  = get_args(sys.argv)
    ...
    coord_obc_zos={'north':  {'time':time, lon_str:lon.data  }
    ...
    regridder = xe.Regridder(ds_var, da_regrid, "bilinear", periodic=False, reuse_weights=True)
...
def get_args(args):
    ...
    return var, ds_grid, depth, ds_var, uv, lati, latf, loni, lonf, fnt
#============================================================================= 
