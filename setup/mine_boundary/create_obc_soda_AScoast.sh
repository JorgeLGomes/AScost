...
fnames=('soda3.3.1_5dy_ocean_reg_2001-2002.nc'
        'soda3.3.1_5dy_ocean_reg_2001-2002.nc'
        'soda3.3.1_5dy_ocean_reg_2001-2002.nc'
	'soda3.3.1_5dy_ocean_reg_2001-2002.nc'
	'soda3.3.1_5dy_ocean_reg_2001-2002.nc')
...
#for n in 3 4; do
    ...
    if [[ $remap_obc_python = 1 ]]; then
        ...
        #python ${src}/remap_obc_from_soda_v2.sh ${fgrid} ${dirdata}${fname} ${v} $lati $latf $loni $lonf || exit #2> python.log || exit
        #python ${src}/remap_obc_from_soda_v2_depth.sh ${fgrid} ${dirdata}${fname} $ocean_topog ${v} $lati $latf $loni $lonf || exit #2> python.log || exit
#        ${src}/remap_obc_from_soda_v3.sh ${fgrid} ${dirdata}${fname} $ocean_topog ${v} $lati $latf $loni $lonf || exit #2> python.log || exit
...
set -x 
    for n in 0 1 2 ; do
        rm -f ${fronteiraname[$n]}_obc_soda.nc
