...
datadir='/home/nicole/workdir/AScoast/forcing_subset_ERA5/'
outdir='/home/nicole/workdir/AScoast/forcing_final_ERA5/'
...
#    previous = xr.open_dataset(f"{datadir}/{f}_{year-1}.nc").isel(time=-1)
    next_data = xr.open_dataset(f"{datadir}/{f}_{year+1}.nc")
