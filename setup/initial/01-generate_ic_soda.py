...
#    soda_file = '/Volumes/P1/Data/SODA/SODA_3.3.1/1995/soda3.3.1_5dy_ocean_reg_1995_01_04.nc'
    soda_file = '/Volumes/P1/Data/SODA/SODA_3.3.1/2001/soda3.3.1_5dy_ocean_reg_2001_10_29.nc'
    start_date = np.datetime64('2001-11-01T00:00:00')
    # Used in filename below, don't change
    start_str = np.datetime_as_string(start_date, unit='D')
    
    # Save the ICs here:
    output_file = f'/Volumes/A1/workdir/nicole/AScoast/INPUT/soda_ic_75z_{start_str}.nc'
    vgrid_file = '/Volumes/A1/workdir/nicole/AScoast/vgrid/vgrid_75_2m.nc'
    grid_file = '/Volumes/A1/workdir/nicole/AScoast/grid/ocean_hgrid.nc'
